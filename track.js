...
/*
    ...
    the shipment details from appearing.
*/
...
async function loadShipment() {
    ...
    try {
        /*
            -------------------------------------------------
            STEP 1
            Get shipment from YOUR backend.
            -------------------------------------------------
        */
        const response =
            await fetch(
                `/api/shipment/track/${encodeURIComponent(trackingCode)}`,
                {
                    method: "GET",
                    cache: "no-store"
                }
        ...
        */
        ...
        /*
            -------------------------------------------------
            STEP 3
            SHOW THE CUSTOMER THE RESULT IMMEDIATELY.
            -------------------------------------------------
        */
        showShipmentContent();
        /*
            ...
            The customer does not wait for:
            - Nominatim
            - Leaflet
            - OSRM
            - map tiles
        ...
        */
        ...
        showError(
            "Unable to connect to the tracking server. Please make sure the server is running and try again."
        );
    }
}
/* =========================================================
...
async function initializeShipmentMap(data) {
    /*
        Prevent multiple map builds at the same time.
    */
    if (mapInitializing) {
        return;
    }
    ...
    try {
        /*
            Remove old map only when we actually
            need to rebuild it.
        */
        if (map) {
            map.remove();
        ...
        */
        ...
        /*
            ...
            keep map available but don't block page.
        */
        if (
            !origin ||
            !destination
        ...
        */
        ...
        /*
            ...
            This happens AFTER the shipment details
            have already been shown to the customer.
        */
...
async function geocodeLocation(location) {
    ...
    try {
        ...
        /*
            A map service failure must NEVER
...
async function refreshShipment() {
    ...
    try {
        ...
        /*
            -------------------------------------------------
            IMPORTANT:
            Update the shipment information immediately.
        ...
        */
        ...
        displayShipment(data);
        /*
            Update current map marker only if
            backend supplies coordinates.
        */
        updateCurrentMapLocation(data);
    } catch (error) {
        console.warn(
...
function updateCurrentMapLocation(data) {
    ...
    /*
        If backend doesn't provide coordinates,
        don't rebuild the map every 3 seconds.
    */
    if (
        latitude === null ||
        longitude === null
